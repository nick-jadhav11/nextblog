  ...
  return (
    <div className='bg-white p-12 rounded-lg shadow-lg'>
        ...
        <div className='mt-10'>
            ...
            <div className="mt-8">
                <button className="block w-full p-4 text-base md:text-lg text-white font-bold hover:bg-blue-950 bg-blue-800 transition-all duration-300 cursor-pointer">Trial Now</button>
            </div>
        </div>
    </div>
  )
